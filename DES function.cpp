...
/*	std::stringstream stream;
	stream << std::hex << outputINdec<<endl<<
...
int main()
{
	...
	string key48;
	cin>>key48;
	//cout<<input32<<"   "<<key48<<endl;
	string input32INbin=HexToBin(input32);
	//cout<<input32INbin<<endl;//<<BinToHEX(input32INbin);
	string EPoutput=EP(input32INbin);
	//cout<<EPoutput<<endl<<key48<<endl;
	string XORout=str_xor(EPoutput,key48);
	//cout<<XORout<<endl;
	string SBOXout=SBox(XORout);
	//cout<<SBOXout<<endl;
	string SBOXoutINbin=HexToBin(SBOXout);
	//cout<<SBOXoutINbin<<endl;
	string output=SP(SBOXoutINbin);
